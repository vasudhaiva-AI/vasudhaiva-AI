...
@push('script')
    ...
    <script>
        // Ace Editor'u başlatıyoruz
        var dashboardCodeBeforeHead = ace.edit("dashboard_code_before_head");
        dashboardCodeBeforeHead.session.setMode("ace/mode/html");

        var dashboardCodeBeforeBody = ace.edit("dashboard_code_before_body");
        dashboardCodeBeforeBody.session.setMode("ace/mode/html");

        // Formun submit işlemini dinliyoruz
        document.getElementById('configForm').addEventListener('submit', function (event) {
            event.preventDefault(); // Formun otomatik gönderimini durdur

            // Ace Editor içeriklerini FormData'ya ekliyoruz
            ...
            // AJAX ile form verilerini gönderiyoruz
            $.ajax({
                type: "POST",
