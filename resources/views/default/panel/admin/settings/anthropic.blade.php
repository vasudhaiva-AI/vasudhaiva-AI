        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    >
                        <option
                                value="{{EntityEnum::CLAUDE_3_5_SONNET->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_3_5_SONNET->value) == EntityEnum::CLAUDE_3_5_SONNET->value ? 'selected' : null }}
                        >
                            {{ __(EntityEnum::CLAUDE_3_5_SONNET->label()) }}
                        </option>

                        <option
                                value="{{EntityEnum::CLAUDE_3_OPUS->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_3_OPUS->value) == EntityEnum::CLAUDE_3_OPUS->value ? 'selected' : null }}
                        >
                            {{ __(EntityEnum::CLAUDE_3_OPUS->label()) }}
                        </option>
                        <option
                                value="{{EntityEnum::CLAUDE_3_SONNET->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_3_SONNET->value) == EntityEnum::CLAUDE_3_SONNET->value ? 'selected' : null }}
                        >
                            {{ __(EntityEnum::CLAUDE_3_SONNET->label()) }}
                        </option>
                        <option
                                value="{{EntityEnum::CLAUDE_3_HAIKU->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_3_HAIKU->value) == EntityEnum::CLAUDE_3_HAIKU->value ? 'selected' : null }}
                        >
                            {{ __(EntityEnum::CLAUDE_3_HAIKU->label()) }}
                        </option>
                        <option
                                value="{{EntityEnum::CLAUDE_2_1->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_2_1->value) == EntityEnum::CLAUDE_2_1->value ? 'selected' : null }}
                        >
                            {{ __(EntityEnum::CLAUDE_2_1->label()) }}
                        </option>

                        <option
                                value="{{EntityEnum::CLAUDE_2_0->value}}"
                                {{ setting('anthropic_default_model', EntityEnum::CLAUDE_2_0->value) == EntityEnum::CLAUDE_2_0->value ? 'selected' : null }}
                        >
                            {{ __('Claude 2') }}
                        </option>
                        <option
