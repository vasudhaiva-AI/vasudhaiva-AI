            ...
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    >
                        ...
                        >
                            <option
                                value="{{EntityEnum::DALL_E_2->value}}"
                                {{ $settings_two->dalle === EntityEnum::DALL_E_2->value ? 'selected' : null }}
                            >
                                {{ EntityEnum::DALL_E_2->value }}</option>
                            <option
                                value="{{EntityEnum::DALL_E_3->value}}"
                                {{ $settings_two->dalle === EntityEnum::DALL_E_3->value ? 'selected' : null }}
                            >
                                {{ EntityEnum::DALL_E_3->value }}</option>
                        </select>
                    </x-card>
                </div>
            </div>
            <div class="col-md-12">
                <div class="mb-3">
                    ...
                    >
                        ...
                        >
                            <option
                                value="{{EntityEnum::DAVINCI->value}}"
                                {{ $setting->openai_default_model === EntityEnum::DAVINCI->value ? 'selected' : null }}
                            >
                                {{ __('Davinci (Expensive &amp; Capable)') }}</option>
                            <option
                                value="{{EntityEnum::GPT_3_5_TURBO_16K->value}}"
                                {{ $setting->openai_default_model === \App\Domains\Entity\Enums\EntityEnum::GPT_3_5_TURBO_16K->value ? 'selected' : null }}
                            >
                                {{ __(EntityEnum::GPT_3_5_TURBO_16K->label()) }}</option>
                            <option
                                value="{{EntityEnum::GPT_3_5_TURBO->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_3_5_TURBO->value ? 'selected' : null }}
                            >
                                {{ __('ChatGPT (Most Expensive & Fastest & Most Capable)') }}</option>

                            <option
                                value="{{EntityEnum::GPT_3_5_TURBO_0125->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_3_5_TURBO_0125->value ? 'selected' : null }}
                            >
                                {{ __('ChatGTP (Updated Knowledge cutoff of Sep 2021, 16k)') }}</option>
                            <option
                                value="{{EntityEnum::GPT_4->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_4->value ? 'selected' : null }}
                            >
                                {{ __(EntityEnum::GPT_4->label().' (Most Expensive & Fastest & Most Capable)') }}</option>

                            <option
                                value="{{EntityEnum::GPT_4_1106_PREVIEW->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_4_1106_PREVIEW->value  ? 'selected' : null }}
                            >
                                {{ __('GPT-4 Turbo (Updated Knowledge cutoff of April 2023, 128k)') }}
                            </option>
                            <option
                                value="{{EntityEnum::GPT_4_0125_PREVIEW->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_4_0125_PREVIEW->value ? 'selected' : null }}
                            >
                                {{ __('GPT-4 Turbo (Updated Knowledge cutoff of Dec 2023, 128k)') }}
                            </option>
                            <option
                                value="{{EntityEnum::GPT_4_TURBO->value}}"
                                {{ $setting->openai_default_model === EntityEnum::GPT_4_TURBO->value ? 'selected' : null }}
                            >
                                {{ __('GPT-4 Turbo with Vision (Updated Knowledge cutoff of Dec 2023, 128k)') }}
                            </option>
                            <option
                                value="{{EntityEnum::GPT_4_O->value}}"
                                @selected($setting->openai_default_model === EntityEnum::GPT_4_O->value)
                            >
                            ...
                            <option
                                value="{{EntityEnum::GPT_4_O_MINI->value}}"
                                @selected($setting->openai_default_model === EntityEnum::GPT_4_O_MINI->value)
                            >
                            ...
                            <option
                                value="{{EntityEnum::GPT_4_O1_PREVIEW->value}}"
                                @selected($setting->openai_default_model === EntityEnum::GPT_4_O1_PREVIEW->value)
                            >
                                {{ __('GPT o1-preview (Updated Knowledge cutoff of Dec 2023, 128k)') }}
                            </option>
                            <option
                                value="{{EntityEnum::GPT_4_O1_MINI->value}}"
                                @selected($setting->openai_default_model === EntityEnum::GPT_4_O1_MINI->value)
                            >
                                {{ __('GPT o1-mini (Updated Knowledge cutoff of Dec 2023, 128k)') }}
                            </option>
