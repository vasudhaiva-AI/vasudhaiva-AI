                ...
                <div class="col-md-8 mx-auto">
                    ...
                    >
                        ...
                        @switch(setting('default_ai_engine', 'openai'))
                            ...
                            @case('anthropic')
                                <div class="row">
                                    @if ($app_is_demo)
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __(\App\Domains\Engine\Enums\EngineEnum::ANTHROPIC->label().' Api Keys Secret') }}</label>
                                                <input
                                                        class="form-control"
                            ...
                            @case(\App\Domains\Engine\Enums\EngineEnum::GEMINI->value)
                                <div class="row">
                                    @if ($app_is_demo)
                                        <div class="col-md-12">
                                            <div class="mb-3">
                                                <label class="form-label">{{ __(\App\Domains\Engine\Enums\EngineEnum::GEMINI->label().' Api Keys Secret') }}</label>
                                                <input
                                                        class="form-control"
                                                        id="gemini_api_keys"
                                                        type="text"
                                    ...
                                    @else
                                        <div class="col-md-12">
                                            <div
                                                    class="form-control mb-3 border-none p-0 [&_.select2-selection--multiple]:!rounded-[--tblr-border-radius] [&_.select2-selection--multiple]:!border-[--tblr-border-color] [&_.select2-selection--multiple]:!p-[1em_1.23em]">
                                                <label class="form-label">{{ __(\App\Domains\Engine\Enums\EngineEnum::GEMINI->label().' API Secret') }}</label>
                                                <select
                                                        class="form-control select2"
                                                        id="gemini_api_keys"
                                                        name="gemini_api_keys"
