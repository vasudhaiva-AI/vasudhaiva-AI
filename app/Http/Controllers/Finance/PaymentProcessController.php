...
class PaymentProcessController extends Controller
{
    ...
    public function startSubscriptionCheckoutProcess(Request $request, $gateway = null, $referral = null): ?RedirectResponse
    {
    ...
    public function startPrepaidCheckoutProcess(Request $request, $gateway = null, $referral = null): ?RedirectResponse
    {
        if ($gateway !== 'freeservice' && $request->isMethod('post')) {
            $gateways = Gateways::where('is_active', 1)->pluck('code')->toArray();
            $request->validate([
